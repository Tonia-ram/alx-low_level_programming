...
Returns 0 otherwise
1. A unction that checks for a digit (0 through 9).
...
You can only use _putchar twice in your code
5. A unction that prints 10 times the numbers, from 0 to 14, followed by a new line.
...
12.  A a function that prints an integer.
